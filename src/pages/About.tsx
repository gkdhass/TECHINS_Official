            ...
            <AnimatedSection direction="right" className="space-y-6">
              ...
              <div className="flex gap-8 pt-4">
                {[
                  ...
                  <div key={i}>
                    <p className="text-3xl font-bold text-[#fa9a02]">{item.value}</p>
      ...
      <section className="py-20 bg-[#B7B7B7] dark:bg-[#0C120C] text-neutral-900 dark:text-neutral-100">
        <div className="container mx-auto px-4 grid md:grid-cols-2 gap-8">
          <AnimatedSection direction="left">
            <motion.div
              whileHover={{ y: -4 }}
              className="bg-[#2a2f2a] dark:bg-[#141a14] text-white rounded-2xl p-8 h-full shadow-lg"
            >
      ...
      <section className="py-20 bg-[#B7B7B7] dark:bg-[#0C120C] text-neutral-900 dark:text-neutral-100">
        <div className="container mx-auto px-4">
          <AnimatedSection className="text-center max-w-2xl mx-auto mb-12">
            <h2 className="text-3xl lg:text-4xl font-bold mb-4">Founder's Note</h2>
            <p className="text-neutral-600 dark:text-neutral-400">Personal perspective behind TECHINS</p>
          </AnimatedSection>

          <AnimatedSection>
            <motion.div
              whileHover={{ y: -8 }}
              className="max-w-md mx-auto bg-[#2a2f2a] dark:bg-[#141a14] text-white rounded-2xl p-8 text-center shadow-lg"
            >
              ...
              <p className="text-[#fa9a02] mb-2">Founder & CEO – TECHINS</p>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              <AnimatedSection key={i} delay={i * 0.1}>
                <motion.div
                  whileHover={{ y: -8 }}
                  className="bg-[#2a2f2a] dark:bg-[#141a14] text-white rounded-xl p-6 text-center h-full shadow-lg"
                >
