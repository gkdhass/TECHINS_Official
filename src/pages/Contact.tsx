...
const Contact = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const templateId = isInternship ? internshipTemplateId : contactTemplateId;
  ...
  return (
    <Layout>
      {/* HERO */}
      <section className="py-14 sm:py-20 bg-[#fffcf2] dark:bg-[#00030d] text-[#262a2b] dark:text-white">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
            ...
            <AnimatedSection direction="left">
              <div className="bg-[#786e67] dark:bg-[#1a1d1f] rounded-2xl p-5 sm:p-6 lg:p-8 text-white">
                ...
                {isSuccess ? (
                  ...
                  <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <Button type="submit" disabled={isLoading} className="w-full bg-[#fa9a02] text-black py-3">
                      {isLoading ? (
                        <>
            ...
            <AnimatedSection direction="right" className="space-y-6">
              ...
              <div className="bg-[#786e67] dark:bg-[#1a1d1f] rounded-2xl p-5 sm:p-6 text-white">
              ...
              <div className="bg-[#786e67] dark:bg-[#1a1d1f] rounded-2xl p-5 sm:p-6">
