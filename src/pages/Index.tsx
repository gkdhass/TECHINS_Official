...
const textRevealVariants = {
  ...
  visible: (i: number) => ({
    ...
    y: 0,
    filter: "blur(0px)",
    transition: { delay: i * 0.2, duration: 1.1, ease: [0.25, 0.46, 0.45, 0.94] },
  }),
};
...
const cardVariants = {
  ...
  visible: { opacity: 1, y: 0, scale: 1, transition: { duration: 1.0, ease: "easeOut" } },
};

const iconVariants = {
  hidden: { scale: 0, rotate: -20 },
  visible: { scale: 1, rotate: 0, transition: { type: "spring", stiffness: 120, damping: 16 } },
};
  ...
  const features = [
    {
      ...
      description: "Structured learning that strictly follows curriculum standards while improving understanding.",
      icon: (
    ...
    },
    {
      ...
      description: "Strong fundamentals that improve exam performance with genuine understanding.",
      icon: (
        <svg width="36" height="36" viewBox="0 0 24 24" fill="none" stroke="#fa9a02" strokeWidth="2">
    ...
    },
    {
      ...
      description: "Connecting classroom concepts with practical, real-life applications.",
      icon: (
        <svg width="36" height="36" viewBox="0 0 24 24" fill="none" stroke="#fa9a02" strokeWidth="2">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              ...
              <motion.h1
                custom={1}
                variants={textRevealVariants}
                className="text-4xl md:text-5xl lg:text-6xl font-bold text-neutral-900 dark:text-neutral-100"
              >
              ...
              <motion.p
                custom={2}
                variants={textRevealVariants}
                className="text-neutral-700 dark:text-neutral-300 max-w-lg"
              >
              ...
              <motion.div custom={3} variants={textRevealVariants} className="flex gap-4 flex-wrap">
                <Button asChild size="lg" className="bg-[#fa9a02] text-black hover:bg-[#fa9a02]/90">
                  <Link to="/courses">
                    Explore Our Approach <ChevronRight className="ml-2 w-4 h-4" />
                  </Link>
                </Button>
                <Button asChild size="lg" variant="outline" className="border-neutral-700 dark:border-neutral-400 text-neutral-900 dark:text-neutral-100">
                  <Link to="/contact">Work With TECHINS</Link>
                </Button>
              </motion.div>
            </div>

            <div className="aspect-[4/3] rounded-2xl overflow-hidden shadow-2xl bg-transparent">
        ...
        >
          <AnimatedSection className="text-center max-w-2xl mx-auto mb-12">
            <motion.h2
              custom={0}
              variants={textRevealVariants}
              className="text-3xl lg:text-4xl font-bold text-neutral-900 dark:text-neutral-100"
            >
          ...
          <motion.div variants={containerVariants} className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {features.map((item, index) => (
              <motion.div
                ...
                className="bg-[#2a2f2a] dark:bg-[#141a14] rounded-xl p-6 text-white shadow-lg"
              >
